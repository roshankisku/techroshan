...
<body>
<?php
    $paypal_mode = get_settings('paypal_mode');
    $paypal_client_id_sandbox = get_settings('paypal_client_id_sandbox');
    $paypal_client_id_production = get_settings('paypal_client_id_production');
?>
