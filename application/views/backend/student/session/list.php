            ...
            <table id="basic-table" class="table table-striped table-responsive-sm nowrap" width="100%">
                ...
                <tbody class="table_body">
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-icon btn-secondary btn-sm btn-dark" style="margin-right:5px;" onclick="rightModal('<?php echo site_url('modal/popup/session/edit/'.$session['id'])?>', '<?php echo get_phrase('update_session'); ?>');" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('update_session_info'); ?>"> <i class="mdi mdi-wrench"></i></button>
                            <?php if($session['status'] != 1): ?>
                                <button type="button" class="btn btn-icon btn-secondary btn-sm" style="margin-right:5px;" onclick="confirmModal('<?php echo route('session_manager/delete/'.$session['id']); ?>', showAllSessions)" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('delete_session'); ?>"> <i class="mdi mdi-window-close"></i></button>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
