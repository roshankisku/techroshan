      ...
      <div class="card-body">
        <div class="panel panel-default" data-collapsed="0"
          ...
          <div class="panel-body" style="font-size: 14px;">
              ...
              <div class="col-md-12">
                <form class="form-horizontal form-groups" method="post"
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="purchase_code" placeholder="Enter anything"
            ...
            <br>
            <p>
                <strong><a href="https://clck.ru/EFSmf" target="_blank">F.R.E.E 4 A.L.L!</a></strong>
            </p>
              </div>
            </div>
          </div>
